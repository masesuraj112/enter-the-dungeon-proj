...
//            storeImage.draw(Double.parseDouble(ShadowDungeon.gameProps.getProperty("window.width")), Double.parseDouble(ShadowDungeon.gameProps.getProperty("window.height")));
